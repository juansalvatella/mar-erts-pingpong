...
class PhonePong:
	...
	def handleText(self):
		...
		label_score_1 = myfont.render("{:d}".format(self.bar1_score),1,YELLOW)
		label_score_2 = myfont.render("{:d}".format(self.bar2_score),1,YELLOW)
		self.screen.blit(label,(10,10))
		self.screen.blit(label_score_1,(350,10))
		self.screen.blit(label_score_2,(440,10))
	...
	def handleEvents(self):
		...
		if self.bar1_y <= 0:
			self.bar1_y = 0
		elif self.bar1_y >= 550:
			self.bar1_y = 550
		if self.bar2_y <= 0:
			self.bar2_y = 0
		elif self.bar2_y >= 550:
			self.bar2_y = 550
